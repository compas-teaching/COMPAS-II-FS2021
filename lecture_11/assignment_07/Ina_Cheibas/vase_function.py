...
from compas_slicer.print_organization import set_linear_velocity_by_overhang
...
def main():
    ...
    v_list = []
    for i in range(print_organizer.number_of_layers):
        if i < 2:
            v_list.append(22)
        else:
            v_list.append(100)
    ...
    set_linear_velocity_by_overhang(print_organizer, overhang_range = [0.0, 0.1], velocity_range = v_list, bound_remapping=True)
