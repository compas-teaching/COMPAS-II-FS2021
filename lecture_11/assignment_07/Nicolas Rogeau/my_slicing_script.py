...
# own function
from my_slicing_texture import create_dovetail_texture
...
# ==============================================================================
DATA = os.path.join(os.getcwd(), 'data') # For some reasons... I had to change os.path.dirname(__file__) to os.getcwd() to get a path.
...
def main():
    ...
    ############################################################################
    create_dovetail_texture(slicer, dovetail_distance=50)
